...
class ExerciseFragment : Fragment() {
    ...
    private val exercises : MutableList<Exercise> = mutableListOf(
        ...
        Exercise(exerciseType = "giftfour",exerciseCount = 15 ),
        Exercise(exerciseType = "giftwo",exerciseCount = 5 ),
        )
    ...
    override fun onCreateView(
       ...
       val v=   inflater.inflate(R.layout.fragment_excercise, container, false)
        ...
        nextButton.setOnClickListener { view:View ->
            ...
            if (exerciseIndex<exerciseSize){
                ...
                view.findNavController().navigate(R.id.action_exerciseFragment2_to_wellDoneFragment2)
            }
        }
        exitButton.setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.action_exerciseFragment2_to_tryAgainFragment)
        )
    ...
    private fun setExercise(){
        ...
        (activity as AppCompatActivity).supportActionBar?.title = String.format(getString
            (R.string.title_android_fitness_exercise),exerciseIndex+1,exerciseSize)
    }
